...
DYANAMODB_JSON_PATH1="./cases/case8/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case8/dynamodb/dr_event.json"

# === XMLファイル ===
XML_STEP1="./cases/case8/payloads/oadr_poll.xml"
XML_STEP2="./cases/case8/payloads/oadr_created_event.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case8/responses"
