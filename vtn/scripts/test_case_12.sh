...
DYANAMODB_JSON_PATH1="./cases/case12/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case12/dynamodb/dr_event1.json"
DYANAMODB_JSON_PATH3="./cases/case12/dynamodb/dr_event2.json"

# === XMLファイル ===
XML_STEP1="./cases/case12/payloads/oadr_poll_1.xml"
XML_STEP2="./cases/case12/payloads/oadr_created_event_1.xml"
XML_STEP3="./cases/case12/payloads/oadr_poll_2.xml"
XML_STEP4="./cases/case12/payloads/oadr_created_event_2.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case12/responses"
