...
DYANAMODB_JSON_PATH1="./cases/case5/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case5/dynamodb/offer_report.json"
DYANAMODB_JSON_PATH3="./cases/case5/dynamodb/power_report.json"

# === XMLファイル ===
XML_STEP1="./cases/case5/payloads/oadr_poll.xml"
XML_STEP2="./cases/case5/payloads/oadr_created_report.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case5/responses"
RESP_FILE1="${RESP_DIR}/1_oadr_poll.xml"
RESP_FILE2="${RESP_DIR}/2_oadr_created_report.xml"
