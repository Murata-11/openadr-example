...
DYANAMODB_JSON_PATH1="./cases/case9/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case9/dynamodb/dr_event.json"

# === XMLファイル ===
XML_STEP1="./cases/case9/payloads/oadr_poll.xml"
XML_STEP2="./cases/case9/payloads/oadr_created_event.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case9/responses"
