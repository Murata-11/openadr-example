...
DYANAMODB_JSON_PATH1="./cases/case7/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case7/dynamodb/offer_report.json"
DYANAMODB_JSON_PATH3="./cases/case7/dynamodb/power_report.json"

# === XMLファイル ===
XML_STEP1="./cases/case7/payloads/oadr_poll.xml"
XML_STEP2="./cases/case7/payloads/oadr_created_report.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case7/responses"
