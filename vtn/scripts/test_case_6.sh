...
DYANAMODB_JSON_PATH1="./cases/case6/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case6/dynamodb/offer_report.json"
DYANAMODB_JSON_PATH3="./cases/case6/dynamodb/power_report.json"

# === XMLファイル ===
XML_STEP1="./cases/case6/payloads/oadr_poll.xml"
XML_STEP2="./cases/case6/payloads/oadr_canceled_report.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case6/responses"
