...
DYANAMODB_JSON_PATH1="./cases/case10/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case10/dynamodb/dr_event1.json"
DYANAMODB_JSON_PATH3="./cases/case10/dynamodb/dr_event2.json"
DYANAMODB_JSON_PATH4="./cases/case10/dynamodb/dr_event3.json"
DYANAMODB_JSON_PATH5="./cases/case10/dynamodb/dr_event4.json"

# === XMLファイル ===
XML_STEP1="./cases/case10/payloads/oadr_poll.xml"
XML_STEP2="./cases/case10/payloads/oadr_created_event.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case10/responses"
...
main() {
  ...
  put_item_to_dynamodb "$DYNAMODB_TABLE_NAME4" "$DYANAMODB_JSON_PATH4"
  step1
  step2
