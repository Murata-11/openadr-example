...
DYANAMODB_JSON_PATH1="./cases/case14/dynamodb/meta.json"
DYANAMODB_JSON_PATH2="./cases/case14/dynamodb/power_report.json"

# === XMLファイル ===
XML_STEP1="./cases/case14/payloads/oadr_update_report.xml"
XML_STEP2="./cases/case14/payloads/oadr_updated_report.xml"

# === レスポンス保存先 ===
RESP_DIR="./cases/case14/responses"
