...
HOSTNAMES="${HOSTNAMES:-openadr-web,localhost}"   # ADDED
...
openssl req -new -sha256 -key dummy_vtn.key -subj "/C=NL/ST=Other/O=OpenLEADR Dummy VTN/CN=openadr-web" -out dummy_vtn.csr
